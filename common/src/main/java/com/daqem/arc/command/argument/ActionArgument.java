...
public class ActionArgument implements ArgumentType<IAction> {
    ...
    public IAction parse(StringReader reader) throws CommandSyntaxException {
        return actionManager.getAction(ResourceLocation.read(reader)).orElseThrow(() -> {
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
        return SharedSuggestionProvider.suggest(actionManager.getActionLocationStrings(), builder);
    }
