...
public interface IRewardType<T extends IReward> {
    ...
    IRewardType<GiveRecipesReward> GIVE_RECIPES = register(Arc.getId("give_recipes"), new GiveRecipesReward.Serializer());
    ...
    IRewardType<EnchantItemReward> ENCHANT_ITEM = register(Arc.getId("enchant_item"), new EnchantItemReward.Serializer());
