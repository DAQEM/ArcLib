...
public class ShootProjectileAction extends AbstractAction {
    ...
    public IActionSerializer<?> getSerializer() {
        return ActionSerializer.SHOOT_PROJECTILE;
    }

    public static class Serializer implements ActionSerializer<ShootProjectileAction> {
        ...
        @Override
        public ShootProjectileAction fromNetwork(ResourceLocation location, FriendlyByteBuf friendlyByteBuf, ResourceLocation actionHolderLocation, IActionHolderType<?> actionHolderType, boolean performOnClient, List<IReward> rewards, List<ICondition> conditions) {
            return new ShootProjectileAction(location, actionHolderLocation, actionHolderType, performOnClient, rewards, conditions);
        }

        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, ShootProjectileAction type) {
