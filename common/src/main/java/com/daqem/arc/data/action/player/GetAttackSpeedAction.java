...
public class GetAttackSpeedAction extends AbstractAction {
    ...
    public IActionSerializer<?> getSerializer() {
        return ActionSerializer.GET_ATTACK_SPEED;
    }

    public static class Serializer implements ActionSerializer<GetAttackSpeedAction> {
        ...
        @Override
        public GetAttackSpeedAction fromNetwork(ResourceLocation location, FriendlyByteBuf friendlyByteBuf, ResourceLocation actionHolderLocation, IActionHolderType<?> actionHolderType, boolean performOnClient, List<IReward> rewards, List<ICondition> conditions) {
            return new GetAttackSpeedAction(location, actionHolderLocation, actionHolderType, true, rewards, conditions);
        }

        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, GetAttackSpeedAction type) {
