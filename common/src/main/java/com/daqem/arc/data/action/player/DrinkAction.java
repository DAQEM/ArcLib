...
public class DrinkAction extends AbstractAction {
    ...
    public DrinkAction(Identifier location, Identifier actionHolderLocation, IActionHolderType<?> actionHolderType, List<IReward> rewards, List<ICondition> conditions) {
    ...
    public static class Serializer implements IActionSerializer<DrinkAction> {
        ...
        @Override
        public DrinkAction fromJson(Identifier location, JsonObject jsonObject, Identifier actionHolderLocation, IActionHolderType<?> actionHolderType, List<IReward> rewards, List<ICondition> conditions) {
            return new DrinkAction(location, actionHolderLocation, actionHolderType, rewards, conditions);
        }

        @Override
        public DrinkAction fromNetwork(Identifier location, RegistryFriendlyByteBuf friendlyByteBuf, Identifier actionHolderLocation, IActionHolderType<?> actionHolderType, List<IReward> rewards, List<ICondition> conditions) {
            return new DrinkAction(location, actionHolderLocation, actionHolderType, rewards, conditions);
        }
