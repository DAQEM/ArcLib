...
public class SprintStartAction extends AbstractAction {
    ...
    public IActionSerializer<?> getSerializer() {
        return ActionSerializer.SPRINT_START;
    }

    public static class Serializer implements ActionSerializer<SprintStartAction> {
        ...
        @Override
        public SprintStartAction fromNetwork(ResourceLocation location, FriendlyByteBuf friendlyByteBuf, ResourceLocation actionHolderLocation, IActionHolderType<?> actionHolderType, boolean performOnClient, List<IReward> rewards, List<ICondition> conditions) {
            return new SprintStartAction(location, actionHolderLocation, actionHolderType, performOnClient, rewards, conditions);
        }

        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, SprintStartAction type) {
