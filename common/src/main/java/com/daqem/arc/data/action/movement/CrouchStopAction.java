...
public class CrouchStopAction extends AbstractAction {
    ...
    public static class Serializer implements ActionSerializer<CrouchStopAction> {
        ...
        @Override
        public CrouchStopAction fromNetwork(ResourceLocation location, FriendlyByteBuf friendlyByteBuf, ResourceLocation actionHolderLocation, IActionHolderType<?> actionHolderType, boolean performOnClient, List<IReward> rewards, List<ICondition> conditions) {
            return new CrouchStopAction(location, actionHolderLocation, actionHolderType, performOnClient, rewards, conditions);
        }
