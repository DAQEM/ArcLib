...
public class CrouchAction extends AbstractAction {
    ...
    public IActionSerializer<?> getSerializer() {
        return ActionSerializer.CROUCH;
    }

    public static class Serializer implements ActionSerializer<CrouchAction> {
        ...
        @Override
        public CrouchAction fromNetwork(ResourceLocation location, FriendlyByteBuf friendlyByteBuf, ResourceLocation actionHolderLocation, IActionHolderType<?> actionHolderType, boolean performOnClient, List<IReward> rewards, List<ICondition> conditions) {
            return new CrouchAction(location, actionHolderLocation, actionHolderType, performOnClient, rewards, conditions);
        }

        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, CrouchAction type) {
