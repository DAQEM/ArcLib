...
public class RidingEntityTypeCondition extends AbstractCondition {
    ...
    public static class Serializer implements IConditionSerializer<RidingEntityTypeCondition> {
        ...
        @Override
        public RidingEntityTypeCondition fromJson(Identifier location, JsonObject jsonObject, boolean inverted) {
            return new RidingEntityTypeCondition(inverted, getEntityType(jsonObject, "entity_type"));
        }

        @Override
        public RidingEntityTypeCondition fromNetwork(Identifier location, RegistryFriendlyByteBuf friendlyByteBuf, boolean inverted) {
