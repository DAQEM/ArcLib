...
public class HurtPlayerAction extends AbstractAction {
    ...
    public IActionSerializer<?> getSerializer() {
        return ActionSerializer.HURT_PLAYER;
    }

    public static class Serializer implements ActionSerializer<HurtPlayerAction> {
        ...
        @Override
        public HurtPlayerAction fromNetwork(ResourceLocation location, FriendlyByteBuf friendlyByteBuf, ResourceLocation actionHolderLocation, IActionHolderType<?> actionHolderType, boolean performOnClient, List<IReward> rewards, List<ICondition> conditions) {
            return new HurtPlayerAction(location, actionHolderLocation, actionHolderType, performOnClient, rewards, conditions);
        }

        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, HurtPlayerAction type) {
